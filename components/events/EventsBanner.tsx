...
export default function EventsBanner({ events }: { events: Event[] }) {
  ...
  return (
    <div className="relative w-full border-b border-border overflow-hidden bg-bg-base" style={{ height: '560px' }}>
      ...
      {/* Main content */}
      <div className="absolute left-16 right-12 top-0 bottom-0 flex flex-col">

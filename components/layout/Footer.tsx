...
const FacebookIcon = () => (
  <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047v-2.66c0-3.025 1.792-4.697 4.533-4.697 1.312 0 2.686.236 2.686.236v2.971h-1.514c-1.491 0-1.956.932-1.956 1.888v2.261h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z" />
  </svg>
)
...
const socialLinks = [
  ...
  { href: 'https://instagram.com/databased_iisc',                      Icon: InstagramIcon,label: 'Instagram' },
  { href: 'https://www.facebook.com/people/Databased/100075487702866/',Icon: FacebookIcon, label: 'Facebook' },
  { href: 'https://linkedin.com/company/databased-iisc',               Icon: LinkedinIcon, label: 'LinkedIn' },
]
